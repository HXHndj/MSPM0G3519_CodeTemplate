...
void OLED_W_RES(uint8_t BitValue)
{
	...
	if (BitValue == 0){DL_GPIO_clearPins(OLED_OLED_RES_PORT, OLED_OLED_RES_PIN);}
	else if (BitValue == 1){DL_GPIO_setPins(OLED_OLED_RES_PORT, OLED_OLED_RES_PIN);}
}
...
void OLED_W_DC(uint8_t BitValue)
{
	...
	if (BitValue == 0){DL_GPIO_clearPins(OLED_OLED_DC_PORT, OLED_OLED_DC_PIN);}
	else if (BitValue == 1){DL_GPIO_setPins(OLED_OLED_DC_PORT, OLED_OLED_DC_PIN);}
}
...
void OLED_W_CS(uint8_t BitValue)
{
	...
	if (BitValue == 0){DL_GPIO_clearPins(OLED_OLED_CS_PORT, OLED_OLED_CS_PIN);}
	else if (BitValue == 1){DL_GPIO_setPins(OLED_OLED_CS_PORT, OLED_OLED_CS_PIN);}
}
