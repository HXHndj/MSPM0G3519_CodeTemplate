...
#define MT_Star 80
const struct MusicNote StarScore[] = {
    {M1, MT_Star},{M1, MT_Star},{M5, MT_Star},{M5, MT_Star},
    {M6, MT_Star},{M6, MT_Star},{M5, MT_Star*2},{0, MT_Star},{M4, MT_Star},
    {M4, MT_Star},{M3, MT_Star},{M3, MT_Star},{M2, MT_Star},{M2, MT_Star},
    {M1, MT_Star*2},{1, MT_Star}
};

#define MT_Birthday 80
const struct MusicNote BirthdayScore[] = {
    {M1, MT_Birthday},{M1, MT_Birthday},{M2, MT_Birthday*2},{M1, MT_Birthday*2},{M5, MT_Birthday*2},{M4, MT_Birthday*4},{0, MT_Birthday},{M1, MT_Birthday},{M1, MT_Birthday},{M2, MT_Birthday*2},{M1, MT_Birthday*2},{H1, MT_Birthday*2},
	{M5, MT_Birthday*4},{0, MT_Birthday},{M1, MT_Birthday},{M1, MT_Birthday},{H1, MT_Birthday*2},{H5, MT_Birthday*2},{H3, MT_Birthday*2},{M4, MT_Birthday*4},{0, MT_Birthday},{H6, MT_Birthday},{H6, MT_Birthday},{H5, MT_Birthday*2},{H3, MT_Birthday*2},
    {H4, MT_Birthday*2},{H2, MT_Birthday*4},{1, MT_Birthday}      // ÀÖÆ×½áÊø±ê¼Ç
};
